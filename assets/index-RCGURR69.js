...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vu(e,t,n){let r=new Float32Array(iu),i=new G(0,1,0);return new qc({name:`SphericalGaussianBlur`,defines:{n:iu,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:xu(),fragmentShader:`
	...
	`}var Su=class extends yo{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Nc([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Kd={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function qd(e,t){let n=Kd[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Jd=new G;function Yd(){return J.getLuminanceCoefficients(Jd),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Jd.x.toFixed(4)}, ${Jd.y.toFixed(4)}, ${Jd.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Rd(i,i.VERTEX_SHADER,y),S=Rd(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Wd(i,x,`vertex`),n=Wd(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function Wp({viscosity:e=.005,colorFade:t=.96,bgColor:n=`#D1C7DB`,className:r,marbleScale:i=1,marbleSpeed:a=.08,lineCount:o=5,lineWidth:s=.03}){let c=(0,_.useRef)(null),l=(0,_.useRef)({viscosity:e,colorFade:t,bgColor:n,marbleScale:i,marbleSpeed:a,lineCount:o,lineWidth:s});return l.current={viscosity:e,colorFade:t,bgColor:n,marbleScale:i,marbleSpeed:a,lineCount:o,lineWidth:s},(0,_.useEffect)(()=>{let e=c.current;if(!e)return;let t=e.clientWidth,n=e.clientHeight,r=new as,i=new El(-1,1,1,-1,0,1),a=new op({antialias:!1,powerPreference:`high-performance`});a.setSize(t,n),a.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(a.domElement);let o=(e,t)=>new qc({vertexShader:Ip,fragmentShader:e,uniforms:t,depthWrite:!1,depthTest:!1}),s=()=>new yo(t>>1,n>>1,{type:xi,minFilter:di,magFilter:di,format:ki,depthBuffer:!1}),u=()=>({read:s(),write:s(),swap(){let e=this.read;this.read=this.write,this.write=e}}),d=u(),f=u(),p=u(),m=s(),h=new W(1/(t>>1),1/(n>>1)),g=o(Lp,{uTexture:{value:null}}),_=o(Rp,{uTexture:{value:null},uBgColor:{value:new rs(l.current.bgColor)},uTime:{value:0},uMarbleScale:{value:l.current.marbleScale},uMarbleSpeed:{value:l.current.marbleSpeed},uLineCount:{value:l.current.lineCount},uLineWidth:{value:l.current.lineWidth}}),v=o(zp,{uTarget:{value:null},uAspectRatio:{value:t/n},uColor:{value:new G},uPoint:{value:new W},uRadius:{value:Fp}}),y=o(Bp,{uVelocity:{value:null},uSource:{value:null},texelSize:{value:h},dt:{value:.016},dissipation:{value:1}}),b=o(Vp,{uVelocity:{value:null},texelSize:{value:h}}),x=o(Hp,{uPressure:{value:null},uDivergence:{value:null},texelSize:{value:h}}),S=o(Up,{uPressure:{value:null},uVelocity:{value:null},texelSize:{value:h}}),C=new xc(new Rc(2,2));r.add(C);let w=(e,t)=>{C.material=e,a.setRenderTarget(t),a.render(r,i),a.setRenderTarget(null)},T=a.domElement,E=[],D=new G(.3,.6,1),O=(e,r)=>{let i=T.getBoundingClientRect(),a=(e-i.left)/t,o=1-(r-i.top)/n;E.length===0?E.push({x:a,y:o,dx:0,dy:0,moved:!1}):(E[0].dx=(a-E[0].x)*3e3,E[0].dy=(o-E[0].y)*3e3,E[0].x=a,E[0].y=o,E[0].moved=!0)},k=e=>O(e.clientX,e.clientY),A=e=>{e.cancelable&&e.preventDefault(),O(e.touches[0].clientX,e.touches[0].clientY)},j=e=>{e.cancelable&&e.preventDefault(),O(e.touches[0].clientX,e.touches[0].clientY)};T.addEventListener(`mousemove`,k),T.addEventListener(`touchmove`,A,{passive:!1}),T.addEventListener(`touchstart`,j,{passive:!1});let ee=new ResizeObserver(()=>{t=e.clientWidth,n=e.clientHeight,a.setSize(t,n),h.set(1/(t>>1),1/(n>>1)),v.uniforms.uAspectRatio.value=t/n});ee.observe(e);let M,te=performance.now(),ne=()=>{let e=l.current;if(_.uniforms.uBgColor.value.set(e.bgColor),_.uniforms.uTime.value=(performance.now()-te)/1e3,_.uniforms.uMarbleScale.value=e.marbleScale,_.uniforms.uMarbleSpeed.value=e.marbleSpeed,_.uniforms.uLineCount.value=e.lineCount,_.uniforms.uLineWidth.value=e.lineWidth,E.length>0&&E[0].moved){let e=E[0];v.uniforms.uPoint.value.set(e.x,e.y),v.uniforms.uTarget.value=f.read.texture,v.uniforms.uColor.value.set(e.dx,e.dy,0),w(v,f.write),f.swap();let t=Date.now()*.001;D.set(Math.sin(t)*.2+.5,Math.cos(t*.5)*.2+.5,Math.sin(t*.3)*.2+.8),v.uniforms.uTarget.value=d.read.texture,v.uniforms.uColor.value.copy(D),w(v,d.write),d.swap(),e.moved=!1}y.uniforms.uVelocity.value=f.read.texture,y.uniforms.uSource.value=f.read.texture,y.uniforms.dissipation.value=.99-e.viscosity*.14,w(y,f.write),f.swap(),y.uniforms.uVelocity.value=f.read.texture,y.uniforms.uSource.value=d.read.texture,y.uniforms.dissipation.value=e.colorFade,w(y,d.write),d.swap(),b.uniforms.uVelocity.value=f.read.texture,w(b,m),w(g,p.read),x.uniforms.uDivergence.value=m.texture;for(let e=0;e<Pp;e++)x.uniforms.uPressure.value=p.read.texture,w(x,p.write),p.swap();S.uniforms.uPressure.value=p.read.texture,S.uniforms.uVelocity.value=f.read.texture,w(S,f.write),f.swap(),_.uniforms.uTexture.value=d.read.texture,w(_,null),M=requestAnimationFrame(ne)};return ne(),()=>{cancelAnimationFrame(M),ee.disconnect(),T.removeEventListener(`mousemove`,k),T.removeEventListener(`touchmove`,A),T.removeEventListener(`touchstart`,j),d.read.dispose(),d.write.dispose(),f.read.dispose(),f.write.dispose(),p.read.dispose(),p.write.dispose(),m.dispose(),a.dispose(),e.contains(T)&&e.removeChild(T)}},[]),(0,B.jsx)(`div`,{ref:c,className:r,style:{width:`100%`,height:`100%`,background:n,overflow:`hidden`}})}var Gp=[{label:`01`,props:{}},{label:`02`,props:{shape:2,size:1,rounding:.1,gap:0,spacingX:1,spacingY:2,color:`#F95565`,glow:20}},{label:`03`,props:{shape:2,size:.8,rounding:.1,gap:.2,spacingX:1.2,spacingY:.5,color:`#FFB731`,glow:20}},{label:`04`,props:{shape:2,size:1.5,rounding:.2,gap:.5,spacingX:2.2,spacingY:2.2,color:`#25D366`,glow:1}},{label:`05`,props:{shape:2,size:.3,rounding:0,gap:.5,spacingX:.2,spacingY:.2,color:`#EA4242`,glow:1}}];function Kp(){let[e,t]=(0,_.useState)(0);return(0,B.jsxs)(`main`,{className:`px-6 md:px-12 lg:px-24 max-w-6xl mx-auto w-full py-24 pt-12`,children:[(0,B.jsx)(`div`,{className:`pb-12`,children:(0,B.jsxs)(wn,{to:`/works`,className:`text-neutral-500 hover:text-neutral-900 flex gap-2`,children:[(0,B.jsx)(`i`,{className:`material-symbols-rounded`,children:`keyboard_backspace`}),`Back to Works`]})}),(0,B.jsx)(`h1`,{className:`text-3xl font-semibold tracking-tight mb-10`,children:`Creative Coding`}),(0,B.jsxs)(`section`,{className:`mb-16`,children:[(0,B.jsx)(`h2`,{className:`text-xl font-medium mb-2`,children:`Background Effects 01`}),(0,B.jsxs)(`p`,{className:`text-neutral-500 leading-relaxed max-w-2xl mb-6`,children:[`Interactive effects `,(0,B.jsx)(`span`,{className:`font-bold`,children:`created Using AI Tools`}),`. Move your cursor across the canvas to see the effects.`]}),(0,B.jsx)(`div`,{className:`flex gap-2 mb-4`,children:Gp.map((n,r)=>(0,B.jsx)(`button`,{onClick:()=>t(r),className:`px-4 py-1.5 rounded-full text-sm font-medium border transition-colors cursor-pointer ${e===r?`bg-primary-600 hover:bg-primary-700 text-white border-primary-600`:`bg-white text-neutral-500 border-neutral-200 hover:border-neutral-400`}`,children:n.label},n.label))}),(0,B.jsx)(`div`,{className:`w-full aspect-video rounded-xl overflow-hidden border border-neutral-200`,children:(0,B.jsx)(up,{...Gp[e].props},e)})]}),(0,B.jsxs)(`section`,{className:`mb-16`,children:[(0,B.jsx)(`h2`,{className:`text-xl font-medium mb-2`,children:`Background Effects 02`}),(0,B.jsx)(`div`,{className:`w-full aspect-video rounded-xl overflow-hidden border border-neutral-200`,children:(0,B.jsx)(dp,{})})]}),(0,B.jsxs)(`section`,{className:`mb-16`,children:[(0,B.jsx)(`h2`,{className:`text-xl font-medium mb-2`,children:`Background Effects 03`}),(0,B.jsx)(`div`,{className:`w-full aspect-video rounded-xl overflow-hidden border border-neutral-200`,children:(0,B.jsx)(Sp,{})})]}),(0,B.jsxs)(`section`,{className:`mb-16`,children:[(0,B.jsx)(`h2`,{className:`text-xl font-medium mb-2`,children:`Background Effects 04`}),(0,B.jsx)(`div`,{className:`w-full aspect-video rounded-xl overflow-hidden border border-neutral-200`,children:(0,B.jsx)(Np,{imageMask:`/img/image-mask.jpg`})})]}),(0,B.jsxs)(`section`,{className:`mb-16`,children:[(0,B.jsx)(`h2`,{className:`text-xl font-medium mb-2`,children:`Background Effects 05`}),(0,B.jsx)(`div`,{className:`w-full aspect-video rounded-xl overflow-hidden border border-neutral-200`,children:(0,B.jsx)(Wp,{marbleScale:.5,marbleSpeed:.5})})]})]})}function qp(){let{pathname:e}=$e();return(0,B.jsxs)(`main`,{className:`flex flex-col items-center justify-center min-h-[70vh] px-6 text-center`,children:[(0,B.jsx)(`img`,{src:Hn(`/img/404.png`),alt:`Page not found`,className:`w-full max-w-120 h-auto mb-6`}),(0,B.jsxs)(`p`,{className:`text-sm text-neutral-500 mb-8`,children:[(0,B.jsx)(`span`,{className:`font-mono font-bold bg-neutral-100 px-1.5 py-0.5 rounded text-neutral-600`,children:e}),` `,`doesn't exist.`]}),(0,B.jsxs)(wn,{to:`/`,className:`inline-flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700 font-medium transition-colors`,children:[(0,B.jsx)(`i`,{className:`material-symbols-rounded text-base`,children:`arrow_back`}),`Back to home`]})]})}function Jp(){return(0,B.jsx)(xn,{children:(0,B.jsx)(Nt,{children:(0,B.jsxs)(jt,{element:(0,B.jsx)(Jn,{}),children:[(0,B.jsx)(jt,{path:`/`,element:(0,B.jsx)(_r,{})}),(0,B.jsx)(jt,{path:`/case-studies`,element:(0,B.jsx)($r,{children:(0,B.jsx)(br,{})})}),(0,B.jsx)(jt,{path:`/case-studies/:id`,element:(0,B.jsx)($r,{children:(0,B.jsx)(qr,{})})}),(0,B.jsx)(jt,{path:`/works`,element:(0,B.jsx)(ei,{})}),(0,B.jsx)(jt,{path:`/works/digital-paintings`,element:(0,B.jsx)(ti,{})}),(0,B.jsx)(jt,{path:`/works/creative-coding`,element:(0,B.jsx)(Kp,{})}),(0,B.jsx)(jt,{path:`/works/applications`,element:(0,B.jsx)(ri,{})}),(0,B.jsx)(jt,{path:`/resume`,element:(0,B.jsx)(ii,{})}),(0,B.jsx)(jt,{path:`*`,element:(0,B.jsx)(qp,{})})]})})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,B.jsx)(_.StrictMode,{children:(0,B.jsx)(Jp,{})}));