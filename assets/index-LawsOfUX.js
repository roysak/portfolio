...
Bad:
  ...
  ✗ 'File removed.' (From where? Recoverable?)`}]}],a={"Cognitive Load":`bg-primary-100 text-primary-700`,"Gestalt Principles":`bg-violet-100 text-violet-700`,"Memory & Attention":`bg-amber-100 text-amber-700`,"Behaviour & Motivation":`bg-emerald-100 text-emerald-700`};function o(){return(0,r.jsx)(n,{items:i,badgeColors:a,legendLabel:`Category`,labels:t})}export{o as default};