    ...
    <main className="max-w-5xl w-full mx-auto px-6 py-16 pt-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <aside className="lg:col-span-1 flex flex-col gap-10">
          ...
          {/* Summary */}
          <section>
            <h2 className="text-xs font-semibold tracking-widest text-primary-600 uppercase mb-3">Summary</h2>
          ...
          {/* Skills */}
          <section>
            <h2 className="text-xs font-semibold tracking-widest text-primary-600 uppercase mb-4">Skills</h2>
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-2">UX Design</p>
                <div className="flex flex-wrap gap-1.5">
                  {["User Research", "Wireframing", "Prototyping", "Interaction Design", "Design Systems"].map(s => (
                    <span key={s} className="px-2.5 py-1 text-xs rounded-full bg-primary-50 text-primary-700 font-medium">{s}</span>
                  ))}
                </div>
              </div>
              <div>
                <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-2">Frontend</p>
                <div className="flex flex-wrap gap-1.5">
                  {["HTML5", "CSS3", "SCSS", "TailwindCSS", "JavaScript", "TypeScript", "Angular", "React"].map(s => (
                    <span key={s} className="px-2.5 py-1 text-xs rounded-full bg-gray-100 text-neutral-700 font-medium">{s}</span>
                  ))}
                </div>
              </div>
              <div>
                <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-2">Tools</p>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div>
                <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-2">Accessibility</p>
                <div className="flex flex-wrap gap-1.5">
        ...
        <div className="lg:col-span-2 flex flex-col gap-10">
          ...
          <section className="bg-primary-50 rounded-2xl p-6">
            <h2 className="text-xs font-semibold tracking-widest text-primary-600 uppercase mb-4">Key Achievements</h2>
            <ul className="flex flex-col gap-3">
              {[
          ...
          {/* Experience */}
          <section>
            <h2 className="text-xs font-semibold tracking-widest text-primary-600 uppercase mb-6">Experience</h2>
            <div className="flex flex-col gap-8">

              {/* UST */}
              <div>
                <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-4">
                  <h3 className="text-lg font-semibold text-neutral-900">UST</h3>
                  <span className="text-xs text-neutral-400 shrink-0">Dec 2016 – Present</span>
                </div>

                {/* SmartOps */}
                <div className="border-l-2 border-primary-200 pl-4 mb-6">
                  <p className="text-xs font-semibold text-primary-600 uppercase tracking-wide mb-0.5">SmartOps</p>
                  <p className="text-xs text-neutral-400 mb-1">Automation Workflow Builder · AI Marketplace · Dashboard Builder</p>
                  <p className="text-sm font-medium text-neutral-700 mb-2">Specialist I – UX Design <span className="font-normal text-neutral-400">· Sep 2021 – Present</span></p>
                ...
                <div className="border-l-2 border-neutral-200 pl-4 mb-6">
                  <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-0.5">Xtract Web</p>
                  <p className="text-sm font-medium text-neutral-700 mb-2">UI Designer / Developer <span className="font-normal text-neutral-400">· Sep 2020 – Aug 2021</span></p>
                  <ul className="flex flex-col gap-1.5">
                    {[
                ...
                {/* CrystalBall */}
                <div className="border-l-2 border-neutral-200 pl-4 mb-6">
                  <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-0.5">CrystalBall <span className="normal-case font-normal text-neutral-400">(Internal)</span></p>
                  <p className="text-sm font-medium text-neutral-700 mb-2">UI Designer / Developer <span className="font-normal text-neutral-400">· Apr 2020 – Aug 2020</span></p>
                  <ul className="flex flex-col gap-1.5">
                    {[
                ...
                <div className="border-l-2 border-neutral-200 pl-4">
                  <p className="text-xs font-semibold text-neutral-500 uppercase tracking-wide mb-0.5">Ticket Booking</p>
                  <p className="text-sm font-medium text-neutral-700 mb-2">UI Designer / Developer <span className="font-normal text-neutral-400">· Dec 2016 – Mar 2020</span></p>
                  <ul className="flex flex-col gap-1.5">
                    {[
              ...
              <div className="pt-2 border-t border-neutral-100">
                <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-3">
                  <h3 className="text-lg font-semibold text-neutral-900">Vtrio Solutions Pvt Ltd</h3>
                  <span className="text-xs text-neutral-400 shrink-0">2005 – 2016</span>
                </div>
                <p className="text-sm font-medium text-neutral-700 mb-2">UI Designer / Developer</p>
                <ul className="flex flex-col gap-1.5">
                  {[
