      ...
      <div className="w-full max-w-sm">
        ...
        {MODE === "pin" && (
          <div className={`flex flex-col items-center gap-4 ${shaking ? "animate-shake" : ""}`}>
            ...
            <div className="flex gap-3">
              <a href="mailto:roysak@gmail.com?subject=Case%20Study%20Access&body=I%20would%20like%20to%20access%20your%20case%20study" className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors">
                <i className="material-symbols-rounded text-sm text-blue-600">alternate_email</i>Email
              </a>
              <a href="https://wa.me/919846666988?text=Hello%2C%20I%20would%20like%20to%20access%your%20case%20study" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors">
