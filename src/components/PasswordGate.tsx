            ...
            <div className="w-full max-w-sm">
                <div className="mb-8 text-center">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-primary-50 mb-4">
                        <i className="material-symbols-rounded text-primary-600 text-2xl">
                            lock
                        </i>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col items-center gap-4 mt-4">
                            <p className="text-xs text-neutral-400 mt-2">
                                Reach out to me for PIN
                            </p>
                            <div className="flex gap-3">
                                <a
                                    href="mailto:roysak@gmail.com?subject=Case%20Study%20Access&body=I%20would%20like%20to%20access%20your%20case%20study"
                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors">
                                    <i className="material-symbols-rounded text-sm text-blue-600">
                                        alternate_email
                                    </i>
                                    Email
                                </a>
                                <a
                                    href="https://wa.me/919846666988?text=Hello%2C%20I%20would%20like%20to%20access%your%20case%20study"
                                    target="_blank"
                                ...
                                <a
                                    href="tel:+919846666988"
                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full text-neutral-600 hover:bg-neutral-50 transition-colors">
                                    <i className="material-symbols-rounded text-sm text-green-600">
                                        call
                                    </i>
                                    Call
                                </a>
