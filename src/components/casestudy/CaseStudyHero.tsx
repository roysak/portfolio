...
export default function CaseStudyHero({ hero }: Props) {
  return (
    <section id="hero" className="py-24 px-6 md:px-12 lg:px-24 max-w-6xl mx-auto pt-32 pb-20">
      <div>
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-50 text-primary-600 text-xs font-semibold uppercase tracking-wide mb-8">
          {hero.badgeIcon && (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-gray-100 pt-10">
          ...
          <div>
            ...
            <p className="font-medium text-sm">{hero.meta.platform}</p>
          </div>
          <div>
          ...
          <div>
            <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">Focus</p>
